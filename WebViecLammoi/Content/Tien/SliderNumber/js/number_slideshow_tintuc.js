 ...
 */
(function(a){
    a.fn.number_slideshow_tintuc=function(p){
        var p=p||{};
        ...
        var s = p && p.slideshow_window_width ? p.slideshow_window_width : "100";
        ...
        F.show();
        F.find("ul:first").children("li").children("a").children("img").css("width","100%").css("height",t);
        ...
        s_s_n(F.find(".number_slideshow_nav_tintuc"), x, w, z, A, B, C);
        ...
        F.find(".number_slideshow_nav_tintuc").children("li").hover(
            function(){
                stop($(this));
            },
            function(){
        ...
        function play(){
            if(n=="enable"){
                ...
                F.find(".number_slideshow_nav_tintuc").children("li").css("background-color", z);
                F.find(".number_slideshow_nav_tintuc").children("li").children("a").css("color", x);
                F.find(".number_slideshow_nav_tintuc").children("li").eq(E).css("background-color", A);
                F.find(".number_slideshow_nav_tintuc").children("li").eq(E).children("a").css("color", button_current_text_color);
                E++;
                if(E>=G){
                    E=0
                }
        ...
        function stop(a){
            ...
            if(b != (E-1)){
                ...
                F.find(".number_slideshow_nav_tintuc").children("li").css("background-color", z);
                F.find(".number_slideshow_nav_tintuc").children("li").eq(b).css("background-color", A)
            }
        }
        function s_s_ul(a,b,c,d,e,f,g,h,i,l_g){
            a.children("li").css("width","100%").css("height",d);
            if(H == 'enable'){
                a.children("li").each(function(i){
                     a.children("li").eq(i).append("<p>"+a.children("li").eq(i).children("a").children("img").attr("alt")+"</p>");
                });
            }
            a.children("li").children("p").css("background-color", "black").css("color", i).css('width', '100%').css('box-shadow', '0 1px 4px rgba(0,0,0,0.25)').css('padding', '10px') ;
            b=parseInt(b);
            c=parseInt(c);
            d=parseInt(d);
            e=parseInt(e);
            ...
            var j=d+"px";
            var k=c+"px";
            var l = "border: " + f + " solid " + " " + e + "px; height:" + j + "; width: 100%" + "; padding:" + b + "px; background-color:" + g + "; background-image:url(" + l_g + ");";
            a.attr("style",l)
        }
