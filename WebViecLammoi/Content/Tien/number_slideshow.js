...
(function(a){
    a.fn.number_slideshow=function(p){
        ...
        var s=p&&p.slideshow_window_width?p.slideshow_window_width:"auto";
        var t=p&&p.slideshow_window_height?p.slideshow_window_height:"auto";
        ...
        function stop(a){
            ...
            if(b != (E-1)){
                E=b+1;
                F.find("ul:first").children("li").fadeOut(0);
