...
$document->addStyleSheet(JURI::base() . 'modules/mod_'.$module->name.'/engine$GallerySuffix$/style.css');
$document->addScript(JURI::base() . 'modules/mod_'.$module->name.'/engine$GallerySuffix$/jquery.js');
